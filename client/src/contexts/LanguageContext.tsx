...
const translations = {
  en: {
    ...
    'footer.address': 'United States, New York, 395 9th Avenue, Manhattan',
  ...
  de: {
    ...
    'footer.address': 'Vereinigte Staaten, New York, 395 9th Avenue, Manhattan',
    'footer.email': 'initiology@gmail.com',
    'footer.phone': '+1 929 717 4941',
  ...
  ru: {
    ...
    'footer.address': 'США, Нью-Йорк, 9-я авеню, 395, боро Манхэттен',
    'footer.email': 'initiology@gmail.com',
    'footer.phone': '+1 929 717 4941',
